...
pub static mut GetActiveUniform: FnPtr = FnPtr {
            ...
            pub mod BindFragDataLocationIndexed {
                ...
                pub fn load_with<F>(mut loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::BindFragDataLocationIndexed = FnPtr::new(metaloadfn(&mut loadfn, "glBindFragDataLocationIndexed", &[]))
                    }
                }
            }
            ...
            pub mod GetFragDataIndex {
                ...
                pub fn load_with<F>(mut loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::GetFragDataIndex = FnPtr::new(metaloadfn(&mut loadfn, "glGetFragDataIndex", &[]))
                    }
                }
            }
